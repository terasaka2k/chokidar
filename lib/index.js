...
function FSWatcher(_opts) {
  ...
  this._emitReady = function() {
    if (++readyCalls >= this._readyCount) {
      assertExactMatch(readyCalls, this._readyCount);
  ...
  function assertExactMatch(nrOfReady, nrOfPending) {
    if (!FsEventsHandler.canUse()) {
      assert(readyCalls === this._readyCount, 'See _addToNodeFs.');
    }
  }
}
...
FSWatcher.prototype._remove = function(directory, item) {
  ...
  // via multiple paths (such as _handleFile and _handleDirOrSymlink)
